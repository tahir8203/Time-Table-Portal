...
Cover fairness uses editable yearly historical totals with a cutoff date and daily workload credits. Actual cover/leave records remain separate. The default balancing period is the selected year; historical totals replace recorded covers through their cutoff in the score only. Daily credits start on their configured date and exclude every Saturday, Sunday and recorded leave day, including manually configured credits. Month-end rewards have been removed; old reward records never affect scores. Credits are stored with Firebase timetable states and versions.
